<div class="data-box-outer">
	<div class="data-box">
		...
		<p class="data-box-text"><a href="https://query.data.world/s/mrodwdqxrjtz6fakei5c2stdvpljld" target="_blank">Read more about the data.</a></p>
		<p class="data-box-text"><a href="https://data.world/associatedpress/mass-killings-public" target="_blank">Download the data.</a></p>
		<p class="data-box-text">Any questions or corrections concerning the data should be directed to James Alan Fox at <a href="mailto:j.fox@northeastern.edu" target="_blank">j.fox@northeastern.edu</a>.</p>
